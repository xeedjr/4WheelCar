...
#define LINE_TB66_PWMA   PAL_LINE(IOPORT1, 7U) //A7
#define LINE_TB66_PWMB   PAL_LINE(IOPORT1, 6U) //A6
#define LINE_TB66_AIN1   PAL_LINE(IOPORT1, 1U)
#define LINE_TB66_AIN2   PAL_LINE(IOPORT1, 0U)
#define LINE_TB66_BIN1   PAL_LINE(IOPORT1, 5U)
#define LINE_TB66_BIN2   PAL_LINE(IOPORT1, 4U)
#define LINE_TB66_STBY   PAL_LINE(IOPORT2, 0U)
#define PWM_CHAN_TB66_A  ((pwmchannel_t)1)
#define PWM_CHAN_TB66_B  ((pwmchannel_t)0)
#define PWM_TB66_A  (&PWMD3)
#define PWM_TB66_B  (&PWMD3)

#define ENCODE_LEFT_LINE    PAL_LINE(IOPORT2, 5U)
#define ENCODE_RIGHT_LINE   PAL_LINE(IOPORT2, 6U)
#define I2C_SCL_LINE     PAL_LINE(IOPORT2, 6U)
#define I2C_SDA_B_LINE   PAL_LINE(IOPORT2, 7U)
#define VELOCITY_A_LINE   PAL_LINE(IOPORT2, 8U)
//#define VELOCITY_B_LINE   PAL_LINE(IOPORT2, 10U)
#define USB_SWITCH_LINE   PAL_LINE(IOPORT2, 9U)

#define BMP280_I2C_DRIVER	(&I2CD1)
